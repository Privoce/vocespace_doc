...
- [`vocespace_deploy_zh.sh`](https://vocespace.com/local_deploy/vocespace_deploy_zh.sh) - Linux/macOS 自动化部署脚本
- [`vocespace_deploy_zh.bat`](https://vocespace.com/local_deploy/vocespace_deploy_zh.bat) - Windows 自动化部署脚本
- [`README.md`](https://vocespace.com/local_deploy/README.md) - 本说明文档
...
```bash
# 基本使用 - 使用默认配置
sh ./vocespace_deploy_zh.sh

# 使用自定义配置文件
sh ./vocespace_deploy_zh.sh --config ./my-config.json

# 指定宿主机IP
sh ./vocespace_deploy_zh.sh --host-ip 192.168.1.100

# 强制重新安装所有组件
sh ./vocespace_deploy_zh.sh --force

# 跳过某些组件的安装
sh ./vocespace_deploy_zh.sh --skip-redis --skip-livekit

# 组合使用
sh ./vocespace_deploy_zh.sh --config ./config.json --host-ip 192.168.1.100 --force
```
...
```cmd
# REM 基本使用 - 使用默认配置
vocespace_deploy_zh.bat

# REM 使用自定义配置文件
vocespace_deploy_zh.bat --config ./my-config.json

# REM 指定宿主机IP
vocespace_deploy_zh.bat --host-ip 192.168.1.100

# REM 强制重新安装所有组件
vocespace_deploy_zh.bat --force

# REM 跳过某些组件的安装
vocespace_deploy_zh.bat --skip-redis --skip-livekit
```
